...
export default function OfferOption({
  ...
  return (
    ...
    >
      ...
      <span style={{ marginLeft: "auto", fontFamily: HIND, fontWeight: 600, color: "#222", fontSize: "1em", lineHeight: 1.5, display: "flex", alignItems: "baseline", gap: 8 }} className="text-lg sm:text-2xl">
        {oldPrice ? (
          <span style={{ color: "#999", textDecoration: "line-through", fontWeight: 400, fontSize: "0.75em" }}>৳{oldPrice.toFixed(2)}</span>
        ) : null}
        ৳{price.toFixed(2)}
      </span>
    </label>
