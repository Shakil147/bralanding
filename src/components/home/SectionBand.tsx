    ...
    <div style={{ background: "#f85606", textAlign: "center", position: "relative", ...style }} className={className ?? "px-4 py-5 sm:px-5"}>
      ...
      {shapeDivider && (
        <div style={{ position: "absolute", bottom: -1, left: 0, width: "100%", overflow: "hidden", lineHeight: 0, direction: "ltr", transform: "rotate(180deg)" }} aria-hidden="true">
          <svg viewBox="0 0 2600 131.1" preserveAspectRatio="none" style={{ display: "block", position: "relative", left: "50%", width: "calc(100% + 1.3px)", height: 39, transform: "translateX(-50%)" }}>
