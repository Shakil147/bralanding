...
export default function Home() {
  ...
  return (
    <div style={{ background: "#f7f9fc", width: "100%", overflowX: "hidden", color: "#222" }}>
      {/* ===== HEADER ===== */}
      <header style={{ position: "relative", background: "#f85606", padding: "54px 20px 0", textAlign: "center" }}>
        <h1 style={{ fontFamily: HIND, fontWeight: 700, color: "#fff", fontSize: 60, lineHeight: 1.1, margin: "0 0 18px", textShadow: "0 2px 6px rgba(0,0,0,.12)" }}>
          ইন্ডিয়ান লাইক মি ব্রা
        </h1>
        <p style={{ fontFamily: HIND, fontWeight: 600, color: "#fff", fontSize: 26, margin: "0 0 18px" }}>
          অস্বস্তির সাথে ব্রেকআপ
        </p>
        <p style={{ fontFamily: HIND, fontWeight: 600, color: "#fff", fontSize: 26, margin: "0 0 30px" }}>
          ৬ পিস কম্বো অফার প্রাইজ{" "}
          <span style={{ borderBottom: "4px solid #2dbd1b", paddingBottom: 2 }}>৯৯৯ /- টাকা মাত্র</span>
        </p>
        <a href="#order" style={{ ...ORANGE_BTN, marginBottom: 64 }}>
          অর্ডার করুন
        </a>
        <svg
          viewBox="0 0 1440 90"
      ...
      {/* ===== VIDEO ===== */}
      <section style={{ maxWidth: 880, margin: "0 auto", padding: "38px 20px 30px", textAlign: "center" }}>
        ...
        <a href="#order" style={{ ...ORANGE_BTN, marginTop: 34 }}>
          অর্ডার করুন
        </a>
      </section>

      {/* ===== BAND: BENEFITS ===== */}
      <div style={{ background: "#f85606", padding: "26px 20px", textAlign: "center", marginBottom: 8 }}>
        <h2 style={{ fontFamily: HIND, fontWeight: 700, color: "#fff", fontSize: 42, lineHeight: 1.18, margin: "0 auto", maxWidth: 980 }}>
          ইন্ডিয়ান লাইক মি ব্রা ব্যবহারে যেসব সুবিধা পাবেন:
        </h2>
      </div>

      <section style={{ maxWidth: 1080, margin: "0 auto", padding: "34px 22px", display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: 40, alignItems: "start" }}>
        <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 20 }}>
          {BENEFITS.map((b) => (
            <li key={b} style={{ display: "flex", gap: 14, alignItems: "flex-start", fontFamily: NOTO, fontWeight: 600, fontSize: 23, lineHeight: 1.4, color: "#1d1d1d" }}>
      ...
      {/* ===== PRICE BOX ===== */}
      <section style={{ maxWidth: 1040, margin: "14px auto 0", padding: "0 22px" }}>
        <div style={{ background: "#eef5fd", border: "1px solid #f7c9ad", borderRadius: 14, padding: "26px 30px", textAlign: "center" }}>
          <p style={{ fontFamily: HIND, fontWeight: 600, fontSize: 30, color: "#3a3a3a", margin: "0 0 16px" }}>
          ...
          <p style={{ fontFamily: HIND, fontWeight: 600, fontSize: 28, color: "#2a2a2a", margin: 0 }}>
      ...
      {/* ===== BAND: WHY BUY ===== */}
      <div style={{ background: "#f85606", padding: "30px 20px", textAlign: "center", margin: "40px 0 0" }}>
        <h2 style={{ fontFamily: HIND, fontWeight: 700, color: "#fff", fontSize: 46, margin: 0 }}>আমাদের কাছ থেকে কেন কিনবেন?</h2>
      </div>

      <section style={{ maxWidth: 1080, margin: "0 auto", padding: "40px 22px", display: "grid", gridTemplateColumns: ".92fr 1.08fr", gap: 44, alignItems: "center" }}>
        ...
        <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 24 }}>
          {WHY_BUY.map((w) => (
            <li key={w} style={{ display: "flex", gap: 16, alignItems: "flex-start", fontFamily: NOTO, fontWeight: 600, fontSize: 25, lineHeight: 1.4, color: "#1d1d1d" }}>
      ...
      {/* ===== BAND: QUALITY ===== */}
      <div style={{ position: "relative", background: "#f85606", padding: "34px 20px", textAlign: "center", margin: "18px 0 0", transform: "skewY(-1.1deg)", boxShadow: "0 14px 0 rgba(248,86,6,.32)" }}>
        <h2 style={{ fontFamily: HIND, fontWeight: 700, color: "#fff", fontSize: 48, margin: 0, transform: "skewY(1.1deg)" }}>আমাদের পণ্যের কোয়ালিটি</h2>
      </div>

      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "48px 22px 20px", display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 26 }}>
        {["q1", "q2", "q3"].map((q) => (
          <div key={q} style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,.12)" }}>
      ...
      <div style={{ textAlign: "center", padding: "30px 20px 10px" }}>
        <a href="#order" style={ORANGE_BTN}>অর্ডার করুন</a>
      </div>

      {/* ===== 2 POINTS ===== */}
      <section style={{ maxWidth: 1080, margin: "18px auto 0", padding: "0 22px" }}>
        <div style={{ background: "#eef5fd", border: "1px solid #f7c9ad", borderRadius: 16, overflow: "hidden" }}>
          <div style={{ textAlign: "center", padding: "22px 20px", borderBottom: "1px solid #f3d3bf" }}>
            <h3 style={{ fontFamily: HIND, fontWeight: 700, color: "#f85606", fontSize: 38, margin: 0 }}>২ টি গুরুত্বপূর্ন বিষয়</h3>
          </div>
          <div style={{ padding: "30px 34px 36px", display: "flex", flexDirection: "column", gap: 22 }}>
            <div style={{ display: "flex", gap: 16, alignItems: "flex-start", fontFamily: NOTO, fontWeight: 600, fontSize: 25, lineHeight: 1.42, color: "#1d1d1d" }}>
            ...
            <div style={{ textAlign: "center", marginTop: 8 }}>
              <a href="tel:01713536549" style={{ display: "inline-block", fontFamily: HIND, fontWeight: 700, fontSize: 27, color: "#fff", textDecoration: "none", background: "#f85606", borderRadius: "14px 14px 22px 14px", padding: "14px 40px", lineHeight: 1.25, boxShadow: "0 5px 0 rgba(0,0,0,.12)" }}>
      ...
      {/* ===== ORDER FORM ===== */}
      <section id="order" style={{ maxWidth: 1140, margin: "46px auto 70px", padding: "0 22px" }}>
        <div style={{ background: "#eef5fd", border: "5px solid #f85606", borderRadius: 18, padding: "38px 40px 46px" }}>
          <h3 style={{ fontFamily: HIND, fontWeight: 700, fontSize: 34, color: "#222", margin: "0 0 26px" }}>আপনার পছন্দের অফারটি নির্বাচন করুন</h3>

          <label style={{ display: "flex", alignItems: "center", gap: 22, background: "#fff", border: "1px solid #e3e8ef", borderRadius: 12, padding: "18px 24px", marginBottom: 30, cursor: "pointer" }}>
            <input type="radio" name="offer" checked readOnly style={{ width: 22, height: 22, accentColor: "#f85606" }} />
            <img src="/assets/prod.png" alt="" style={{ width: 84, height: 96, objectFit: "cover", borderRadius: 4 }} />
            <span style={{ fontFamily: HIND, fontWeight: 600, fontSize: 26, color: "#222" }}>
              ইন্ডিয়ান লাইক মি ব্রা <span style={{ fontWeight: 500 }}>× 1</span>
            </span>
            <span style={{ marginLeft: "auto", fontFamily: HIND, fontWeight: 600, fontSize: 24, color: "#222" }}>৳999.00</span>
          </label>

          <div style={{ display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: 48 }}>
            {/* billing */}
            <div>
              <h4 style={{ fontFamily: HIND, fontWeight: 700, fontSize: 30, color: "#222", margin: "0 0 24px" }}>Billing details</h4>
              ...
              <h4 style={{ fontFamily: HIND, fontWeight: 700, fontSize: 30, color: "#222", margin: "0 0 18px" }}>Shipping</h4>
              <div style={{ border: "1px solid #d9e1ea", borderRadius: 8, overflow: "hidden" }}>
                {SHIPPING_OPTS.map((opt, i) => (
                  <label key={opt.label} style={{ display: "flex", alignItems: "center", gap: 14, padding: "16px 18px", borderBottom: "1px solid #e4e9f0", cursor: "pointer", fontFamily: HIND, fontSize: 21, color: "#2a2a2a" }}>
                    <input
                      type="radio"
                      name="ship"
                      checked={shipIdx === i}
                    ...
                    <span style={{ fontWeight: 600, whiteSpace: "nowrap" }}>৳ {opt.cost}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            {/* order summary */}
            <div>
              <h4 style={{ fontFamily: HIND, fontWeight: 700, fontSize: 30, color: "#222", margin: "0 0 22px" }}>Your order</h4>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 18, padding: "18px 0", borderBottom: "1px dashed #c5cfdb" }}>
                <img src="/assets/prod.png" alt="" style={{ width: 64, height: 74, objectFit: "cover", borderRadius: 4 }} />
                <span style={{ fontFamily: HIND, fontWeight: 600, fontSize: 21, flex: 1 }}>ইন্ডিয়ান লাইক মি ব্রা</span>
                <span style={{ fontFamily: HIND, fontSize: 20, color: "#555" }}>× 1</span>
                <span style={{ fontFamily: HIND, fontWeight: 600, fontSize: 21 }}>৳ 999</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 0", borderBottom: "1px dashed #c5cfdb" }}>
              ...
              <button
                ...
                style={{ width: "100%", fontFamily: HIND, fontWeight: 700, fontSize: 26, color: "#fff", background: "#f85606", border: "none", borderRadius: 12, padding: 18, cursor: "pointer", boxShadow: "0 5px 0 rgba(0,0,0,.12)" }}
              >
                ⬜ অর্ডার করুন ৳ {total}
              </button>
            </div>
      ...
      {/* ===== FLOATING ===== */}
      <a href="#" style={{ position: "fixed", right: 26, bottom: 104, width: 62, height: 62, borderRadius: "50%", background: "#0084ff", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 6px 18px rgba(0,0,0,.25)", zIndex: 50 }}>
      ...
      <a href="https://wa.me/8801713536549" style={{ position: "fixed", right: 26, bottom: 30, width: 62, height: 62, borderRadius: "50%", background: "#25d366", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 6px 18px rgba(0,0,0,.25)", zIndex: 50 }}>
